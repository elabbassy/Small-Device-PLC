...
/* DATE-TIME was removed from __ANY: added next*/
__ANY_DATE(__DECLARE_IEC_TYPE)
__DECLARE_IEC_TYPE(TIME)
...
typedef enum{
  ...
  /* DATE-TIME was removed from __ANY: added next*/
__ANY_DATE(__decl_enum_type)
__decl_enum_type(TIME)
__ANY_DATE(__decl_enum_pointer)
__decl_enum_pointer(TIME)
__ANY_DATE(__decl_enum_output)
__decl_enum_output(TIME)
